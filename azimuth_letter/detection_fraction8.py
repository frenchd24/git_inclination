...
#     d_min = False # does not need a diameter measurement at all
    ...
    # target_sightline can be either the name of a single target or 'all'
...
#         detection_fraction_filename = '/Users/frenchd/Research/inclination/git_inclination/detection_fraction_minEW200_dmin5_Lstar0-False.p'
        detection_fraction_filename = '/Users/frenchd/Research/inclination/git_inclination/detection_fraction_minEW0_dmin01_Lstar0-False_{0}.p'.format(target_sightline)
...
#                     proceed = False
    ...
    try:
        print 'finished! '
        print
        print 'dv400_imp1000_det, non: ', dv400_imp1000_det, dv400_imp1000_non
        print 'dv400_imp750_det, non : ', dv400_imp750_det,  dv400_imp750_non
        print 'dv400_imp500_det, non : ', dv400_imp500_det,  dv400_imp500_non
        print 'dv400_imp400_det, non : ', dv400_imp400_det,  dv400_imp400_non
        print 'dv400_imp300_det, non : ', dv400_imp300_det,  dv400_imp300_non
        print 'dv400_imp200_det, non : ', dv400_imp200_det,  dv400_imp200_non
        print 'dv400_imp100_det, non : ', dv400_imp100_det,  dv400_imp100_non
        print 'dv400_imp50_det, non  : ', dv400_imp50_det,   dv400_imp50_non
        print 'dv400_imp25_det, non  : ', dv400_imp25_det,   dv400_imp25_non
        print
        print
        print
        print 'Detection fraction for 1000 kpc: ', float(dv400_imp1000_det) / (float(dv400_imp1000_det) + dv400_imp1000_non)
        print 'Detection fraction for 750 kpc: ', float(dv400_imp750_det) / (float(dv400_imp750_det) + dv400_imp750_non)
        print 'Detection fraction for 500 kpc: ', float(dv400_imp500_det) / (float(dv400_imp500_det) + dv400_imp500_non)
        print 'Detection fraction for 400 kpc: ', float(dv400_imp400_det) / (float(dv400_imp400_det) + dv400_imp400_non)
        print 'Detection fraction for 300 kpc: ', float(dv400_imp300_det) / (float(dv400_imp300_det) + dv400_imp300_non)
        print 'Detection fraction for 200 kpc: ', float(dv400_imp200_det) / (float(dv400_imp200_det) + dv400_imp200_non)
        print 'Detection fraction for 100 kpc: ', float(dv400_imp100_det) / (float(dv400_imp100_det) + dv400_imp100_non)
        print 'Detection fraction for 50 kpc: ', float(dv400_imp50_det)  / (float(dv400_imp50_det) + dv400_imp50_non)
        print 'Detection fraction for 25 kpc: ', float(dv400_imp25_det)  / (float(dv400_imp25_det) + dv400_imp25_non)
        print
        print
        ...
        print
        print
        print 'Detection fraction for 0.0001 L: ', float(dv400_l0001_det) / (float(dv400_l0001_det) + dv400_l0001_non)
        print 'Detection fraction for 0.0005 L: ', float(dv400_l0005_det) / (float(dv400_l0005_det) + dv400_l0005_non)
        print 'Detection fraction for 0.001 L: ', float(dv400_l001_det) / (float(dv400_l001_det)    + dv400_l001_non)
        print 'Detection fraction for 0.005 L: ', float(dv400_l005_det) / (float(dv400_l005_det)    + dv400_l005_non)
        print 'Detection fraction for 0.01 L: ', float(dv400_l01_det)   / (float(dv400_l01_det)     + dv400_l01_non)
        print 'Detection fraction for 0.05 L: ', float(dv400_l05_det)   / (float(dv400_l05_det)     + dv400_l05_non)
        print 'Detection fraction for 0.1 L: ', float(dv400_l1_det)     / (float(dv400_l1_det)      + dv400_l1_non)
        print 'Detection fraction for 0.5 L: ', float(dv400_l5_det)     / (float(dv400_l5_det)      + dv400_l5_non)
        print 'Detection fraction for 0.75 L: ', float(dv400_l75_det)   / (float(dv400_l75_det)     + dv400_l75_non)
        print
        print
        print
        ...
        print
        print
        print 'Detection fraction for 0.25 imp/vir: ', float(dv400_rvir025_det) / (float(dv400_rvir025_det)    + dv400_rvir025_non)
        print 'Detection fraction for 0.5 imp/vir: ', float(dv400_rvir05_det)   / (float(dv400_rvir05_det)     + dv400_rvir05_non)
        print 'Detection fraction for 0.75 imp/vir: ', float(dv400_rvir075_det) / (float(dv400_rvir075_det)    + dv400_rvir075_non)
        print 'Detection fraction for 1.0 imp/vir: ', float(dv400_rvir1_det)    / (float(dv400_rvir1_det)      + dv400_rvir1_non)
        print 'Detection fraction for 1.5 imp/vir: ', float(dv400_rvir15_det)   / (float(dv400_rvir15_det)     + dv400_rvir15_non)
        print 'Detection fraction for 2.0 imp/vir: ', float(dv400_rvir2_det)    / (float(dv400_rvir2_det)      + dv400_rvir2_non)
        print 'Detection fraction for 2.5 imp/vir: ', float(dv400_rvir25_det)   / (float(dv400_rvir25_det)     + dv400_rvir25_non)
        print
        print
