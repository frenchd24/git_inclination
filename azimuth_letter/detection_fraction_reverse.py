...
$Id: detection_fraction_reverse.py v1.0 02/27/2019

Calculate detection fraction of galaxies -> Correlate each detected line with the galaxies
instead of correlating galaxies with the detection list.

This should say that for a particular line (e.g., line strength?) a galaxy is detected
at some distance, orientation with some frequency


Also produce a detection fraction vs azimuth plot where the mean azimuth in each bin is 
weighted by the impact parameter of each galaxy
...
#         detection_fraction_filename = '/Users/frenchd/Research/inclination/git_inclination/detection_fraction_minEW50.p'
        ...
        saveDirectory = '/Users/frenchd/Research/test/reverse_distributions/'
...
##########################################################################################
    ...
    #     ax1.grid(b=None, which='major', axis='both', alpha=0.5)
        ...
        savefig('{0}/reverse_likelihood_weighted_azimuth_hist_dmin_01_minEW_0.pdf'.format(saveDirectory),format='pdf',bbox_inches='tight')
...
#         print 'all_R_vir: ',all_R_vir
#         print
#         print 'all_impact: ',all_impact
#         print
#         print 'all_W: ',all_W
#         print
#         print 'all_az: ',all_az
...
#         print 'azimuths: ',azimuths
        ...
        for rvir, impact, az in zip(R_virs, impacts, azimuths):
            if (impact / rvir) <= 1.5:
...
#         print 'outside_det_frac: ',outside_det_frac
    ...
    #     xlim(0, 10000)
        ...
        savefig('{0}/reverse_azimuth_detection_fraction_rvir1_5_separation_dmin01_minEW_0.pdf'.format(saveDirectory),format='pdf',bbox_inches='tight')
