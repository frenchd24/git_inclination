...
##########################################################################################    
    ...
    for target in target_dict:
        ...
        L_dict['Names'].append(L_list[0]['Name'])
        L_dict['Vhels'].append(L_list[0]['Vhel'])
        L_dict['impacts'].append(L_list[0]['impact'])
        L_dict['R_virs'].append(L_list[0]['R_vir'])
        L_dict['Lstars'].append(L_list[0]['Lstar'])
        L_dict['MajDiams'].append(L_list[0]['MajDiam'])
        L_dict['azimuths'].append(L_list[0]['azimuth'])
        L_dict['likelihoods'].append(L_list[0]['likelihood'])
        L_dict['Ws'].append(L_list[0]['W'])
        L_dict['vs'].append(L_list[0]['v'])

        # --- append the lowest impact results to the overall result dictionary
        impact_dict['Names'].append(impact_list[0]['Name'])
        impact_dict['Vhels'].append(impact_list[0]['Vhel'])
        impact_dict['impacts'].append(impact_list[0]['impact'])
        impact_dict['R_virs'].append(impact_list[0]['R_vir'])
        impact_dict['Lstars'].append(impact_list[0]['Lstar'])
        impact_dict['MajDiams'].append(impact_list[0]['MajDiam'])
        impact_dict['azimuths'].append(impact_list[0]['azimuth'])
        impact_dict['likelihoods'].append(impact_list[0]['likelihood'])
        impact_dict['Ws'].append(impact_list[0]['W'])
        impact_dict['vs'].append(impact_list[0]['v'])
