...
\subfigure[]{\label{impact_vir}\includegraphics[width=0.48\textwidth]{impact(virial)_50_difHistograms.pdf}}
...
\begin{figure*}[ht!]
        ...
        \caption{\small{A map of where all absorption features occur, split into 3 inclination ranges: $0 \leq i \le 40$, $40 \leq i \le 65$, $65 \leq i$.}}
        \label{azimuthMap}
        \vspace{5pt}
\end{figure*} 
