...
\begin{figure}[ht!]
\centering
  \subfigure[]{\includegraphics[width=1.\linewidth]{MRK290_system-3192_cut.jpg}}{\label{line}}
  \subfigure[]{\includegraphics[width=1.\linewidth]{map_MRK290_3207.pdf}\label{impactmap}}
  \caption{\small{a) An example of Ly$\alpha$ lines found in a sightline towards target MRK290 at 3192 and 3207 km/s. b) A map of \textit{all} galaxies within a 500 kpc impact parameter of target MRK290 sightline and with velocity ($cz$) within 400 km/s of absorption detected at 3192 and 3207 km/s (central black star). The galaxy NGC5987 ($v=4494$ km/s, inclination = $71^{\circ}$) can be unambiguously paired with the Ly$\alpha$ absorption feature at $v=4295$ km/s because it is the largest and closest galaxy in both physical and velocity space to the absorption feature.}}
\vspace{5pt}
\end{figure}
