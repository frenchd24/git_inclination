...
\begin{figure}[b!]
        ...
        \caption{\small{Distribution of $L/L_{\**}$ values for all galaxies in the dataset. Black vertical lines highlight 1, 0.5, 0.1, 0.05 and 0.01 $L_{\**}$.}}
        \label{completeness}
\end{figure} 
...
\begin{figure}[h!]
        ...
        \caption{\small{Equivalent width of each absorber as a function of the inclination angle of the associated galaxy. The dashed black line shows the mean $EW$ of all absorbers in bins of $15^{\circ}$.} \textbf{Open markers correspond to absorbers within 1 $R_{vir}$ of their associated galaxy.}}
...
\begin{figure}[ht!]
        ...
        \caption{\small{Equivalent width as a function of the velocity separation between the galaxy and absorption line. \textbf{Open markers correspond to absorbers within 1 $R_{vir}$ of their associated galaxy.}}}
        \label{W_veldif}
        \vspace{5pt}
\end{figure} 
