...
$Id:  buildDataLists3.py, v 5.0 12/02/2015

This is the first part of histograms3.py. This buids up lists of data from the input
data file (LG_correlation_combined3.csv) and saves it as a pickle file.

This should only need to be used once, then smaller, individual codes will use the pickled
data to make plots.
...
v6: update for use with the new, automatically generated LG_correlation_combined5.csv table
    makes pilotData3.p  - (12/02/2015)
    
v7: updated for LG_correlation_combined5_9_edit2.csv and including more general galaxy info
...
def main():
    ...
    if getpass.getuser() == 'David':
        ...
        filename = '/Users/David/Research_Documents/inclination/git_inclination/LG_correlation_combined5.csv'
        ...
        filename = '/usr/users/frenchd/inclination/git_inclination/LG_correlation_combined5.csv'
        pickleFilename = '/usr/users/frenchd/inclination/pilotData3.p'
...
#         print 'line: ',line
        ...
        virInclude = line['include_vir']
        cusInclude = line['include_custom']
