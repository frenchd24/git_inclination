...
#         detection_fraction_vcut_filename = '/Users/frenchd/Research/inclination/git_inclination/detection_fraction_dmin75_vcut2500_minEW50.p'
        detection_fraction_vcut_filename = '/Users/frenchd/Research/inclination/git_inclination/detection_fraction_minEW200_closestonly.p'
...
#         xlim(0, 2.5)
        ...
        if plot_detection_fraction_velcut_both_save:
            print 'saving...'
            savefig('{0}/detection_fraction_{1}_both.pdf'.format(saveDirectory, cut),format='pdf',bbox_inches='tight')
        else:
            show()
