...
def main():
    ...
    plot_b_vel_mean_plus = True
    plot_b_vel_mean_plus_save = True
    
    # plot dopplar b parameter as a function of dv w/o splitting, add other sets if you want
    plot_b_dv_mean_plus = True
    plot_b_dv_mean_plus_save = True
...
#         color_group = color_yellow
        ...
        associated_xs = np.array(associated_Lya_vs)
        ...
        three_xs = np.array(three_Lya_vs)
...
#         xlim(0, 2.5)
        ...
        if plot_b_vel_mean_plus_save:
            savefig('{0}/b(vel)_mean_binSize{1}_plus4.pdf'.format(saveDirectory, binSize),format='pdf',bbox_inches='tight')
        else:
            show()
