...
def main():   
    # plot mean and median azimuth as a function of likelihood for detections and non-detectinos
    # x-axis is likelihood ; y-axis is azimuth ; each L-point gets a detection and non-detection marker
    plot_detection_fraction_likelihood_az = True
    plot_detection_fraction_likelihood_az_save = True
    
    # plot mean and median azimuth as a function of likelihood for detections and non-detectinos
    # x-axis is likelihood ; y-axis is azimuth ; each L-point gets a detection and non-detection marker
    # plots both minEW=0 and minEW=200 lines on same plot
    plot_detection_fraction_like_az_minEW0_200 = True
    plot_detection_fraction_like_az_minEW0_200_save = True

    # plot mean and median azimuth as a function of likelihood for detections and non-detectinos
    # x-axis is likelihood ; y-axis is azimuth ; each L-point gets a detection and non-detection marker
    plot_detection_fraction_impact_az = True
    plot_detection_fraction_impact_az_save = True

    # plot detection fraction as a function of az for both impact and likelihood
    plot_detection_fraction_both_az = True
    plot_detection_fraction_both_az_save = True
    ...
    # plot detection fraction as a function of az for both impact and likelihood
    plot_detection_fraction_vs_az_imp = True
    plot_detection_fraction_vs_az_imp_save = True
...
#         gtPickleFilename = '/Users/frenchd/Research/GT_update2/pickleGT_filteredAll.p'
        ...
        saveDirectory = '/Users/frenchd/Research/inclination/git_inclination/plotting_code/detection_fraction_figs2/'

        detection_fraction_filename = '/Users/frenchd/Research/inclination/git_inclination/detection_fraction_minEW0_dmin10_Lstar0-False.p'
        input_file = 'detection_fraction_minEW0_dmin10_Lstar0-False'
...
#         detection_fraction_min200_filename = '/Users/frenchd/Research/inclination/git_inclination/detection_fraction_minEW200_closestonly2.p'
        detection_fraction_min200_filename = '/Users/frenchd/Research/inclination/git_inclination/detection_fraction_minEW200_dmin01_Lstar0-False.p'
...
##########################################################################################
    ...
    # now for likelihood detections az
    ...
    # now for likelihood non-detections az
...
#     dv400_l75_min300_non_az = dv400_l75_min300_non_az.astype(np.float)
    ...
    print 'Affect of cutting out -99.* from lists: '
    print 'Before dv400_l0001_det_az:'
    print 'Length: ',len(dv400_l0001_det_az)
    print 'Mean: ',mean(dv400_l0001_det_az)
    print
    print 'Before dv400_l01_det_az:'
    print 'Length: ',len(dv400_l01_det_az)
    print 'Mean: ',mean(dv400_l01_det_az)
    print
    print

    #######
    # cut out '-99' from all the data
    # likelihood version first - az
    ...
    print 'After dv400_l0001_det_az:'
    print 'Length: ',len(dv400_l0001_det_az)
    print 'Mean: ',mean(dv400_l0001_det_az)
    print
    print 'After dv400_l01_det_az:'
    print 'Length: ',len(dv400_l01_det_az)
    print 'Mean: ',mean(dv400_l01_det_az)
    print
    
    # now impact version - az
...
#     dv400_imp25_min300_non_az = list(filter(lambda x: x!= -99., dv400_imp25_min300_non_az))
    ...
    print '------------------------- All the data -------------------------'
    print
    print 'dv400_l0001_det_az = ', dv400_l0001_det_az
    print 'dv400_l0005_det_az = ',dv400_l0005_det_az
    print 'dv400_l001_det_az = ',dv400_l001_det_az
    print 'dv400_l005_det_az = ',dv400_l005_det_az
    print 'dv400_l01_det_az = ',dv400_l01_det_az
    print 'dv400_l05_det_az = ',dv400_l05_det_az
    print 'dv400_l1_det_az = ',dv400_l1_det_az
    print 'dv400_l5_det_az = ',dv400_l5_det_az
    print 'dv400_l75_det_az = ',dv400_l75_det_az
    print
    print 'dv400_l0001_non_az = ',dv400_l0001_non_az
    print 'dv400_l0005_non_az = ',dv400_l0005_non_az
    print 'dv400_l001_non_az = ',dv400_l001_non_az
    print 'dv400_l005_non_az = ',dv400_l005_non_az
    print 'dv400_l01_non_az = ',dv400_l01_non_az
    print 'dv400_l05_non_az = ',dv400_l05_non_az
    print 'dv400_l1_non_az = ',dv400_l1_non_az
    print 'dv400_l5_non_az = ',dv400_l5_non_az
    print 'dv400_l75_non_az = ',dv400_l75_non_az
    print
    print
    
    # now impact version - az
    print 'dv400_imp1000_det_az = ',dv400_imp1000_det_az
    print 'dv400_imp750_det_az = ',dv400_imp750_det_az
    print 'dv400_imp500_det_az = ',dv400_imp500_det_az
    print 'dv400_imp400_det_az = ',dv400_imp400_det_az
    print 'dv400_imp300_det_az = ',dv400_imp300_det_az
    print 'dv400_imp200_det_az = ',dv400_imp200_det_az
    print 'dv400_imp100_det_az = ',dv400_imp100_det_az
    print 'dv400_imp50_det_az = ',dv400_imp50_det_az
    print 'dv400_imp25_det_az = ',dv400_imp25_det_az
    print
    print 'dv400_imp1000_non_az = ',dv400_imp1000_non_az
    print 'dv400_imp750_non_az = ',dv400_imp750_non_az
    print 'dv400_imp500_non_az = ',dv400_imp500_non_az
    print 'dv400_imp400_non_az = ',dv400_imp400_non_az
    print 'dv400_imp300_non_az = ',dv400_imp300_non_az
    print 'dv400_imp200_non_az = ',dv400_imp200_non_az
    print 'dv400_imp100_non_az = ',dv400_imp100_non_az
    print 'dv400_imp50_non_az = ',dv400_imp50_non_az
...
##########################################################################################
        ...
        # put together the corresponding y-axis data - mean and medians at each x-point
        #
        # mean detection az
        ...
        # bootstrap errors in MEAN detection az
        ...
        # bootstrap errors in MEAN non-detection az
        ...
        # bootstrap errors in MEDIAN detection az
        ...
        # bootstrap errors in MEDIAN non-detection az
        ...
        # MEAN az for detections with errors
        ax1.errorbar(x,
                    y_det_mean,
                    yerr=y_det_err_mean,
        ...
        # MEDIAN az for detections with errors
        ax1.errorbar(x,
                    y_det_median,
        ...
        # MEAN az for non-detections with errors
        ax1.errorbar(x,
                    y_non_mean,
                    yerr=y_non_err_mean,
        ...
        # MEDIAN az for non-detections with errors
        ax1.errorbar(x,
                    y_non_median,
...
#         leg.get_frame().set_alpha(0.5)
        ...
        if plot_detection_fraction_likelihood_az_save:
            savefig('{0}/{1}-L_az_errors_DF.pdf'.format(saveDirectory, input_file),format='pdf',bbox_inches='tight')
        else:
            show()
...
#             savefig('{0}/detection_fraction_impact_az_errors_lstarcut{1}.pdf'.format(saveDirectory, lstar_cut),format='pdf',bbox_inches='tight')
            savefig('{0}/{1}-impact_az_errors_DF.pdf'.format(saveDirectory, input_file),format='pdf',bbox_inches='tight')
        else:
            show()
...
##########################################################################################
    ...
    if plot_detection_fraction_like_az_minEW0_200:
        fig = figure(figsize=(7.7,5.7))
        ax1 = fig.add_subplot(111)
...
#         xlim(0, 1000)
        ...
        if plot_detection_fraction_like_az_minEW0_200_save:
#             savefig('{0}/detection_fraction_like_az_errors_minEW0_200.pdf'.format(saveDirectory),format='pdf',bbox_inches='tight')
            savefig('{0}/{1}-L_az_errors_DF_minEW0_200.pdf'.format(saveDirectory, input_file),format='pdf',bbox_inches='tight')
...
#             savefig('{0}/detection_fraction_both_az_errors_minEW0_200.pdf'.format(saveDirectory),format='pdf',bbox_inches='tight')
            savefig('{0}/{1}-both_az_errors_DF_minEW0_200.pdf'.format(saveDirectory, input_file),format='pdf',bbox_inches='tight')
        else:
            show()
...
#             savefig('{0}/detection_fraction_vs_az_like_sep15Rvir.pdf'.format(saveDirectory),format='pdf',bbox_inches='tight')
            savefig('{0}/{1}-DF_vs_az_errors_sep01L.pdf'.format(saveDirectory, input_file),format='pdf',bbox_inches='tight')
        else:
            show()
...
##########################################################################################
    ...
    if plot_detection_fraction_vs_az_imp:
        ...
        label_outside500 = r'$\rm \rho > 500 $'
#         label_outside500 = 'Test'
        label_in100_500 = r'$\rm 100 > \rho \leq 500$'
        label_in25_100 = r'$\rm \rho \leq 100$'
...
#         label_l75 = '.75'
        ...
        markerSize_outside500 = 10
        markerSize_in100_500 = 10
        markerSize_in25_100 = 10
        ...
        color_outside500 = color_red
        color_in100_500 = color_yellow
        color_in25_100 = color_blue
...
#######
        ...
        for az in dv400_imp750_det_az:
            az = float(az)
            if az <= 15:
                imp750_det_15.append(az)

            elif az > 15 and az <= 30:
                imp750_det_30.append(az)

            elif az > 30 and az <= 45:
                imp750_det_45.append(az)

            elif az > 45 and az <= 60:
                imp750_det_60.append(az)

            elif az > 60 and az <= 75:
                imp750_det_75.append(az)

            elif az > 75 and az <= 90:
                imp750_det_90.append(az)
            else:
                print 'wtf? imp750_det_az = ',az
            
        for az in dv400_imp750_non_az:
            az = float(az)
            if az <= 15:
                imp750_non_15.append(az)

            elif az > 15 and az <= 30:
                imp750_non_30.append(az)

            elif az > 30 and az <= 45:
                imp750_non_45.append(az)

            elif az > 45 and az <= 60:
                imp750_non_60.append(az)

            elif az > 60 and az <= 75:
                imp750_non_75.append(az)

            elif az > 75 and az <= 90:
                imp750_non_90.append(az)
            else:
                print 'wtf? imp750_non_az = ',az
        ...
        for az in dv400_imp400_det_az:
            az = float(az)
            if az <= 15:
                imp400_det_15.append(az)

            elif az > 15 and az <= 30:
                imp400_det_30.append(az)

            elif az > 30 and az <= 45:
                imp400_det_45.append(az)

            elif az > 45 and az <= 60:
                imp400_det_60.append(az)

            elif az > 60 and az <= 75:
                imp400_det_75.append(az)

            elif az > 75 and az <= 90:
                imp400_det_90.append(az)
            else:
                print 'wtf? imp400_det_az = ',az

        for az in dv400_imp400_non_az:
            az = float(az)
            if az <= 15:
                imp400_non_15.append(az)

            elif az > 15 and az <= 30:
                imp400_non_30.append(az)

            elif az > 30 and az <= 45:
                imp400_non_45.append(az)

            elif az > 45 and az <= 60:
                imp400_non_60.append(az)

            elif az > 60 and az <= 75:
                imp400_non_75.append(az)

            elif az > 75 and az <= 90:
                imp400_non_90.append(az)
            else:
                print 'wtf? imp400_non_az = ',az
        ...
        for az in dv400_imp50_det_az:
            az = float(az)
            if az <= 15:
                imp50_det_15.append(az)

            elif az > 15 and az <= 30:
                imp50_det_30.append(az)

            elif az > 30 and az <= 45:
                imp50_det_45.append(az)

            elif az > 45 and az <= 60:
                imp50_det_60.append(az)

            elif az > 60 and az <= 75:
                imp50_det_75.append(az)

            elif az > 75 and az <= 90:
                imp50_det_90.append(az)
            else:
                print 'wtf? imp50_det_az = ',az

        for az in dv400_imp50_non_az:
            az = float(az)
            if az <= 15:
                imp50_non_15.append(az)

            elif az > 15 and az <= 30:
                imp50_non_30.append(az)

            elif az > 30 and az <= 45:
                imp50_non_45.append(az)

            elif az > 45 and az <= 60:
                imp50_non_60.append(az)

            elif az > 60 and az <= 75:
                imp50_non_75.append(az)

            elif az > 75 and az <= 90:
                imp50_non_90.append(az)
            else:
                print 'wtf? imp50_non_az = ',az


        for az in dv400_imp25_det_az:
            az = float(az)
            if az <= 15:
                imp25_det_15.append(az)

            elif az > 15 and az <= 30:
                imp25_det_30.append(az)

            elif az > 30 and az <= 45:
                imp25_det_45.append(az)

            elif az > 45 and az <= 60:
                imp25_det_60.append(az)

            elif az > 60 and az <= 75:
                imp25_det_75.append(az)

            elif az > 75 and az <= 90:
                imp25_det_90.append(az)
            else:
                print 'wtf? imp25_det_az = ',az

        for az in dv400_imp25_non_az:
            az = float(az)
            if az <= 15:
                imp25_non_15.append(az)

            elif az > 15 and az <= 30:
                imp25_non_30.append(az)

            elif az > 30 and az <= 45:
                imp25_non_45.append(az)

            elif az > 45 and az <= 60:
                imp25_non_60.append(az)

            elif az > 60 and az <= 75:
                imp25_non_75.append(az)

            elif az > 75 and az <= 90:
                imp25_non_90.append(az)
            else:
                print 'wtf? imp25_non_az = ',az
        ...
        y_imp750_det = [len(imp750_det_15),
                     len(imp750_det_30),
                     len(imp750_det_45),
                     len(imp750_det_60),
                     len(imp750_det_75),
        ...
        y_imp750_non = [len(imp750_non_15),
                     len(imp750_non_30),
                     len(imp750_non_45),
                     len(imp750_non_60),
                     len(imp750_non_75),
        ...
        y_imp400_det = [len(imp400_det_15),
                     len(imp400_det_30),
                     len(imp400_det_45),
                     len(imp400_det_60),
                     len(imp400_det_75),
        ...
        y_imp400_non = [len(imp400_non_15),
                     len(imp400_non_30),
                     len(imp400_non_45),
                     len(imp400_non_60),
                     len(imp400_non_75),
        ...
        print 'y_imp1000_det, non : ',y_imp1000_det, ', ',y_imp1000_non
        print 'y_imp750_det, non : ',y_imp750_det, ', ',y_imp750_non
        print 'y_imp500_det, non : ',y_imp500_det, ', ',y_imp500_non
        print 'y_imp400_det, non : ',y_imp400_det, ', ',y_imp400_non
        print 'y_imp300_det, non : ',y_imp400_det, ', ',y_imp400_non
        print 'y_imp200_det, non : ',y_imp200_det, ', ',y_imp200_non
        print 'y_imp100_det, non : ',y_imp100_det, ', ',y_imp100_non
        print 'y_imp50_det, non  : ',y_imp50_det, ', ',y_imp50_non
        print 'y_imp25_det, non  : ',y_imp25_det, ', ',y_imp25_non
        print
        
        # make them all floats
        y_imp1000_det = np.array(y_imp1000_det).astype(np.float)
        y_imp750_det = np.array(y_imp750_det).astype(np.float)
        y_imp500_det = np.array(y_imp500_det).astype(np.float)
        y_imp400_det = np.array(y_imp400_det).astype(np.float)
        ...
        y_imp50_det = np.array(y_imp50_det).astype(np.float)
        y_imp25_det = np.array(y_imp25_det).astype(np.float)

        y_imp1000_non = np.array(y_imp1000_non).astype(np.float)
        y_imp750_non = np.array(y_imp750_non).astype(np.float)
        y_imp500_non = np.array(y_imp500_non).astype(np.float)
        y_imp400_non = np.array(y_imp400_non).astype(np.float)
        ...
        y_imp50_non = np.array(y_imp50_non).astype(np.float)
        y_imp25_non = np.array(y_imp25_non).astype(np.float)
        
        outside500_det = np.array(y_imp1000_det) + np.array(y_imp750_det) + np.array(y_imp500_det)
        outside500_non = np.array(y_imp1000_non) + np.array(y_imp750_non) + np.array(y_imp500_non)
        
        in100_500_det = np.array(y_imp400_det) + np.array(y_imp300_det) + np.array(y_imp200_det)
        in100_500_non = np.array(y_imp400_non) + np.array(y_imp300_non) + np.array(y_imp200_non)
        
        in25_100_det = np.array(y_imp100_det) + np.array(y_imp50_det) + np.array(y_imp25_det)
        in25_100_non = np.array(y_imp100_non) + np.array(y_imp50_non) + np.array(y_imp25_non)

        
        detection_fraction_outside500 = np.array(outside500_det) / np.array(np.array(outside500_det) + np.array(outside500_non))
        detection_fraction_in100_500 = np.array(in100_500_det) / np.array(np.array(in100_500_det) + np.array(in100_500_non))
        detection_fraction_in25_100 = np.array(in25_100_det) / np.array(np.array(in25_100_det) + np.array(in25_100_non))
...
#         detection_fraction_imp100_err = np.sqrt(y_imp100_det) / np.array(np.array(y_imp100_det) + np.array(y_imp100_non))
        ...
        ##########
        print 'x: ',x
        print 'detection_fraction_outside500: ',detection_fraction_outside500
        print 'detection_fraction_in100_500: ',detection_fraction_in100_500
        print 'detection_fraction_in25_100: ',detection_fraction_in25_100
        print
        
        ax1.errorbar(x,
                    detection_fraction_outside500,
#                     yerr=detection_fraction_imp1000_err,
                    marker=symbol_outside500,
                    c=color_outside500,
                    ms=markerSize_outside500,
                    markeredgecolor='black',
                    ls = ls_outside500,
                    lw = lw_outside500,
                    alpha=alpha_outside500,
                    label=label_outside500)

        ax1.errorbar(x,
                    detection_fraction_in100_500,
#                     yerr=detection_fraction_imp500_err,
                    marker=symbol_in100_500,
                    c=color_in100_500,
                    ms=markerSize_in100_500,
                    markeredgecolor='black',
                    ls = ls_in100_500,
                    lw = lw_in100_500,
                    alpha=alpha_in100_500,
                    label=label_in100_500)

        ax1.errorbar(x,
                    detection_fraction_in25_100,
#                     yerr=detection_fraction_imp300_err,
                    marker=symbol_in25_100,
                    c=color_in25_100,
                    ms=markerSize_in25_100,
                    markeredgecolor='black',
                    ls = ls_in25_100,
                    lw = lw_in25_100,
                    alpha=alpha_in25_100,
                    label=label_in25_100)
        ...
        try:
            ...
            in100_500 = mlines.Line2D([], [], color=color_in100_500, marker=symbol_in100_500,lw=lw_in100_500,
                                      markersize=legend_size, markeredgecolor='black', label=label_in100_500)

            outside500 = mlines.Line2D([], [], color=color_outside500, marker=symbol_outside500,lw=lw_outside500,
                                    markeredgecolor='black', markersize=legend_size, label=label_outside500)
                                
            in25_100 = mlines.Line2D([], [], color=color_in25_100, marker=symbol_in25_100,lw=lw_in25_100,
                                    markeredgecolor='black', markersize=legend_size, label=label_in25_100)
                                  
            plt.legend(handles=[outside500, in100_500, in25_100],loc='lower right',
                                    borderpad=0.8, fontsize=legend_font, fancybox=True)
        except Exception, e:
            print
            print "Legend issue: ",e
...
#             savefig('{0}/detection_fraction_vs_az_imp_errors.pdf'.format(saveDirectory),format='pdf',bbox_inches='tight')
            savefig('{0}/{1}-DF_vs_az_errors_imp.pdf'.format(saveDirectory, input_file),format='pdf',bbox_inches='tight')
        else:
            show()
