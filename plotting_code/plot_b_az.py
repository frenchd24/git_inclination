...
$Id:  plot_b_az.py, v 1.0 06/18/18

Plot dopplar b-parameter as a function of azimuth
...
#         color_group = color_yellow
        ...
        group_MajDiams2 = []
        group_azimuths2 = []
        for w, r, i, group, b, l, maj, az in zip(group_Lya_Ws, group_R_virs, group_impacts, group_mems, group_bs, group_ls, group_MajDiams, group_azimuths):
...
#         xlim(0, 2.5)
        ...
        if plot_b_az_mean_plus_save:
            savefig('{0}/b(az)_mean_binSize{1}_plus4.pdf'.format(saveDirectory, binSize),format='pdf',bbox_inches='tight')
        else:
            show()
