...
##########################################################################################
        ...
        frac_imp1000_min50_err = detection_fraction_error(dv400_imp1000_min50_det, dv400_imp1000_min50_non)
        frac_imp750_min50_err = detection_fraction_error(dv400_imp750_min50_det, dv400_imp750_min50_non)
        frac_imp500_min50_err = detection_fraction_error(dv400_imp500_min50_det, dv400_imp500_min50_non)
        frac_imp400_min50_err = detection_fraction_error(dv400_imp400_min50_det, dv400_imp400_min50_non)
        frac_imp300_min50_err = detection_fraction_error(dv400_imp300_min50_det, dv400_imp300_min50_non)
        frac_imp200_min50_err = detection_fraction_error(dv400_imp200_min50_det, dv400_imp200_min50_non)
        frac_imp100_min50_err = detection_fraction_error(dv400_imp100_min50_det, dv400_imp100_min50_non)
        frac_imp50_min50_err = detection_fraction_error(dv400_imp50_min50_det, dv400_imp50_min50_non)
        frac_imp25_min50_err = detection_fraction_error(dv400_imp25_min50_det, dv400_imp25_min50_non)
        ...
        frac_imp1000_min100_err = detection_fraction_error(dv400_imp1000_min100_det, dv400_imp1000_min100_non)
        frac_imp750_min100_err = detection_fraction_error(dv400_imp750_min100_det, dv400_imp750_min100_non)
        frac_imp500_min100_err = detection_fraction_error(dv400_imp500_min100_det, dv400_imp500_min100_non)
        frac_imp400_min100_err = detection_fraction_error(dv400_imp400_min100_det, dv400_imp400_min100_non)
        frac_imp300_min100_err = detection_fraction_error(dv400_imp300_min100_det, dv400_imp300_min100_non)
        frac_imp200_min100_err = detection_fraction_error(dv400_imp200_min100_det, dv400_imp200_min100_non)
        frac_imp100_min100_err = detection_fraction_error(dv400_imp100_min100_det, dv400_imp100_min100_non)
        frac_imp50_min100_err = detection_fraction_error(dv400_imp50_min100_det, dv400_imp50_min100_non)
        frac_imp25_min100_err = detection_fraction_error(dv400_imp25_min100_det, dv400_imp25_min100_non)
        ...
        frac_imp1000_min200_err = detection_fraction_error(dv400_imp1000_min200_det, dv400_imp1000_min200_non)
        frac_imp750_min200_err = detection_fraction_error(dv400_imp750_min200_det, dv400_imp750_min200_non)
        frac_imp500_min200_err = detection_fraction_error(dv400_imp500_min200_det, dv400_imp500_min200_non)
        frac_imp400_min200_err = detection_fraction_error(dv400_imp400_min200_det, dv400_imp400_min200_non)
        frac_imp300_min200_err = detection_fraction_error(dv400_imp300_min200_det, dv400_imp300_min200_non)
        frac_imp200_min200_err = detection_fraction_error(dv400_imp200_min200_det, dv400_imp200_min200_non)
        frac_imp100_min200_err = detection_fraction_error(dv400_imp100_min200_det, dv400_imp100_min200_non)
        frac_imp50_min200_err = detection_fraction_error(dv400_imp50_min200_det, dv400_imp50_min200_non)
        frac_imp25_min200_err = detection_fraction_error(dv400_imp25_min200_det, dv400_imp25_min200_non)
        ...
        frac_imp1000_min300_err = detection_fraction_error(dv400_imp1000_min300_det, dv400_imp1000_min300_non)
        frac_imp750_min300_err = detection_fraction_error(dv400_imp750_min300_det, dv400_imp750_min300_non)
        frac_imp500_min300_err = detection_fraction_error(dv400_imp500_min300_det, dv400_imp500_min300_non)
        frac_imp400_min300_err = detection_fraction_error(dv400_imp400_min300_det, dv400_imp400_min300_non)
        frac_imp300_min300_err = detection_fraction_error(dv400_imp300_min300_det, dv400_imp300_min300_non)
        frac_imp200_min300_err = detection_fraction_error(dv400_imp200_min300_det, dv400_imp200_min300_non)
        frac_imp100_min300_err = detection_fraction_error(dv400_imp100_min300_det, dv400_imp100_min300_non)
        frac_imp50_min300_err = detection_fraction_error(dv400_imp50_min300_det, dv400_imp50_min300_non)
        frac_imp25_min300_err = detection_fraction_error(dv400_imp25_min300_det, dv400_imp25_min300_non)
...
###################
        ...
        frac_l0001_min50_err = detection_fraction_error(dv400_l0001_min50_det, dv400_l0001_min50_non)
        frac_l0005_min50_err = detection_fraction_error(dv400_l0005_min50_det, dv400_l0005_min50_non)
        frac_l001_min50_err = detection_fraction_error(dv400_l001_min50_det, dv400_l001_min50_non)
        frac_l005_min50_err = detection_fraction_error(dv400_l005_min50_det, dv400_l005_min50_non)
        frac_l01_min50_err = detection_fraction_error(dv400_l01_min50_det, dv400_l01_min50_non)
        frac_l05_min50_err = detection_fraction_error(dv400_l05_min50_det, dv400_l05_min50_non)
        frac_l1_min50_err = detection_fraction_error(dv400_l1_min50_det, dv400_l1_min50_non)
        frac_l5_min50_err = detection_fraction_error(dv400_l5_min50_det, dv400_l5_min50_non)
        frac_l75_min50_err = detection_fraction_error(dv400_l75_min50_det, dv400_l75_min50_non)
        ...
        frac_l0001_min100_err = detection_fraction_error(dv400_l0001_min100_det, dv400_l0001_min100_non)
        frac_l0005_min100_err = detection_fraction_error(dv400_l0005_min100_det, dv400_l0005_min100_non)
        frac_l001_min100_err = detection_fraction_error(dv400_l001_min100_det, dv400_l001_min100_non)
        frac_l005_min100_err = detection_fraction_error(dv400_l005_min100_det, dv400_l005_min100_non)
        frac_l01_min100_err = detection_fraction_error(dv400_l01_min100_det, dv400_l01_min100_non)
        frac_l05_min100_err = detection_fraction_error(dv400_l05_min100_det, dv400_l05_min100_non)
        frac_l1_min100_err = detection_fraction_error(dv400_l1_min100_det, dv400_l1_min100_non)
        frac_l5_min100_err = detection_fraction_error(dv400_l5_min100_det, dv400_l5_min100_non)
        frac_l75_min100_err = detection_fraction_error(dv400_l75_min100_det, dv400_l75_min100_non)
        ...
        frac_l0001_min200_err = detection_fraction_error(dv400_l0001_min200_det, dv400_l0001_min200_non)
        frac_l0005_min200_err = detection_fraction_error(dv400_l0005_min200_det, dv400_l0005_min200_non)
        frac_l001_min200_err = detection_fraction_error(dv400_l001_min200_det, dv400_l001_min200_non)
        frac_l005_min200_err = detection_fraction_error(dv400_l005_min200_det, dv400_l005_min200_non)
        frac_l01_min200_err = detection_fraction_error(dv400_l01_min200_det, dv400_l01_min200_non)
        frac_l05_min200_err = detection_fraction_error(dv400_l05_min200_det, dv400_l05_min200_non)
        frac_l1_min200_err = detection_fraction_error(dv400_l1_min200_det, dv400_l1_min200_non)
        frac_l5_min200_err = detection_fraction_error(dv400_l5_min200_det, dv400_l5_min200_non)
        frac_l75_min200_err = detection_fraction_error(dv400_l75_min200_det, dv400_l75_min200_non)
       ...
       # minEW = 300
        ...
        frac_l0001_min300_err = detection_fraction_error(dv400_l0001_min300_det, dv400_l0001_min300_non)
        frac_l0005_min300_err = detection_fraction_error(dv400_l0005_min300_det, dv400_l0005_min300_non)
        frac_l001_min300_err = detection_fraction_error(dv400_l001_min300_det, dv400_l001_min300_non)
        frac_l005_min300_err = detection_fraction_error(dv400_l005_min300_det, dv400_l005_min300_non)
        frac_l01_min300_err = detection_fraction_error(dv400_l01_min300_det, dv400_l01_min300_non)
        frac_l05_min300_err = detection_fraction_error(dv400_l05_min300_det, dv400_l05_min300_non)
        frac_l1_min300_err = detection_fraction_error(dv400_l1_min300_det, dv400_l1_min300_non)
        frac_l5_min300_err = detection_fraction_error(dv400_l5_min300_det, dv400_l5_min300_non)
        frac_l75_min300_err = detection_fraction_error(dv400_l75_min300_det, dv400_l75_min300_non)

        print 'dv400_l0001_min300_det: ',dv400_l0001_min300_det
        print 'dv400_l0001_min300_non: ',dv400_l0001_min300_non
        print 'frac_l0001_min300_err: ',frac_l0001_min300_err
        print
        print 'dv400_l01_min300_det: ',dv400_l01_min300_det
        print 'dv400_l01_min300_non: ',dv400_l01_min300_non
        print 'dv400_l01_min300_err: ',frac_l01_min300_err
        print
        print 'dv400_l75_min300_det: ',dv400_l75_min300_det
        print 'dv400_l75_min300_non: ',dv400_l75_min300_non
        print 'frac_l75_min300_err: ',frac_l75_min300_err
        print
        print
