...
$Id:  plot_EW_vel2.py, v 1.0 07/27/18
...
def main():
    ...
    # plot EW vs dv for all associated and split between MTypes
    plot_EW_dv_MType = True
    plot_EW_dv_MType_save = True
...
#         leg.get_frame().set_alpha(0.5)
        ...
        if plot_EW_dv_MType_save:
            savefig('{0}/W(dv)_MType_binSize{1}_EWcut{2}-{3}_dataset{4}.pdf'.format(saveDirectory, binSize, min_EW, max_EW, data_set),format='pdf',bbox_inches='tight')
        else:
            show()
