...
$Id:  plot_EW_az.py, v 5.4 06/11/18

Plot equivalent width as a function of azimuth.
...
#         bins = 10.
        ...
        # mean L_two_plus
        bin_means,edges,binNumber = stats.binned_statistic(array(L_two_plus_azimuths), 
                                                            array(L_two_plus_Lya_Ws),
                                                            statistic='mean',
                                                            bins=bins)
