...
def main():   
    ...
    # plot detection fraction as a function of inclination for both impact and likelihood
    plot_detection_fraction_vs_inc_imp = False
    plot_detection_fraction_vs_inc_imp_save = False
...
#######
        ...
        for inc in dv400_l001_det_inc:
            inc = float(inc)
            if inc <= 15:
                l001_det_15.append(inc)

            elif inc > 15 and inc <= 30:
                l001_det_30.append(inc)

            elif inc > 30 and inc <= 45:
                l001_det_45.append(inc)

            elif inc > 45 and inc <= 60:
                l001_det_60.append(inc)

            elif inc > 60 and inc <= 75:
                l001_det_75.append(inc)

            elif inc > 75 and inc <= 90:
                l001_det_90.append(inc)
            else:
                print 'wtf? l001_det_inc = ',inc
            
        for inc in dv400_l001_non_inc:
            inc = float(inc)
            if inc <= 15:
                l001_non_15.append(inc)

            elif inc > 15 and inc <= 30:
                l001_non_30.append(inc)

            elif inc > 30 and inc <= 45:
                l001_non_45.append(inc)

            elif inc > 45 and inc <= 60:
                l001_non_60.append(inc)

            elif inc > 60 and inc <= 75:
                l001_non_75.append(inc)

            elif inc > 75 and inc <= 90:
                l001_non_90.append(inc)
            else:
                print 'wtf? l001_non_inc = ',inc
        
        for inc in dv400_l005_det_inc:
            inc = float(inc)
            if inc <= 15:
                l005_det_15.append(inc)

            elif inc > 15 and inc <= 30:
                l005_det_30.append(inc)

            elif inc > 30 and inc <= 45:
                l005_det_45.append(inc)

            elif inc > 45 and inc <= 60:
                l005_det_60.append(inc)

            elif inc > 60 and inc <= 75:
                l005_det_75.append(inc)

            elif inc > 75 and inc <= 90:
                l005_det_90.append(inc)
            else:
                print 'wtf? l005_det_inc = ',inc
            
        for inc in dv400_l005_non_inc:
            inc = float(inc)
            if inc <= 15:
                l005_non_15.append(inc)

            elif inc > 15 and inc <= 30:
                l005_non_30.append(inc)

            elif inc > 30 and inc <= 45:
                l005_non_45.append(inc)

            elif inc > 45 and inc <= 60:
                l005_non_60.append(inc)

            elif inc > 60 and inc <= 75:
                l005_non_75.append(inc)

            elif inc > 75 and inc <= 90:
                l005_non_90.append(inc)
            else:
                print 'wtf? l005_non_inc = ',inc
...
#                     yerr=detection_fraction_l1_err,
        ...
        try:
            ...
            l1_outside = mlines.Line2D([], [], color=color_l1_outside, marker=symbol_l1_outside, lw=lw_l1_outside,
                                    markeredgecolor='black', markersize=legend_size, label=label_l1_outside)
        ...
        if plot_detection_fraction_vs_inc_like_save:
            savefig('{0}/detection_fraction_vs_inc_like_sep15Rvir.pdf'.format(saveDirectory),format='pdf',bbox_inches='tight')
        else:
            show()
