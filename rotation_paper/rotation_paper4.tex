...
RBS1503					&	NGC5907			&	15 29 7.5			&	+56 16 07.0		&   0.09900	& 12276		&  1964	\\
...
16 galaxies have nearby sightlines showing only 1 Ly$\alpha$ component with $\Delta v \pm 400$ \kms, while 17 have multiple absorption components (23 if we count galaxies with more than 1 sightline). 


The following systems exist within 1 $R_vir}$:
1. $\rm NGC3067 : 3C232$ - 
...
. $\rm NGC3351 : SDSSJ104335.90+115129.0$, 
5. $\rm NGC3432 : CSO295$, 
. $\rm NGC3432 : CSO295$, 
6. $\rm NGC5951 : 2E1530+1511$, 
7. $\rm UGC09760 : SDSSJ151237.15+012846.0$, 
. $\rm NGC3351 : SDSSJ104335.90+115129.0$, 
8. $\rm NGC4565 : RX_J1236.0+2641$, 
9. $\rm NGC3666 : SDSSJ112439.50+113117.0$, 
. $\rm NGC4565 : RX_J1236.0+2641$, 
. $\rm NGC3666 : SDSSJ112439.50+113117.0$, 
10. $\rm UGC08146 : PG1259+593$, 
. $\rm NGC5951 : 2E1530+1511$, 
. $\rm UGC08146 : PG1259+593$, 

11. $\rm NGC5364 : SDSSJ135726.27+043541.4$, Ly$\alpha$ at 1124 and 1296 \kms, $EW$ = 83, 92 m$\AA$.
...
\colhead{Galaxy}  	&  \colhead{Target} 				&  \colhead{$\rho$ }  &  \colhead{Az.}      & \colhead{$V_{sys}$}	      &  \colhead{$V_{rot}$ }        &  \colhead{$V_{Ly\alpha}$}    & \colhead{$W_{Ly\alpha}$}       & \colhead{Cyl. Model}    & \colhead{NFW Model }  \\
			  	&          			 			&  \colhead{[\kms]}  	& \colhead{[Deg.]}  & \colhead{[\kms]}	     & \colhead{[\kms]}  		& \colhead{[\kms]}  		      &  \colhead{[m\AA]}  			& \colhead{[\kms]} 	       & \colhead{[\kms]} }
\colnumbers
\startdata
