...
%&  \colhead{ Anti-rotating }		&  \colhead{ Uncertain}  	&  \colhead{ co-rotating} 		&  \colhead{Anti-rotating 		&  \colhead{Co-rotating} 		&  \colhead{ Anti-rotating} 
%& 			 			&						& $\rho \leq 1$				& $\rho \leq 1$				& $\rho \gt 1$				& $\rho \gt 1$		
...
Finally, we consider the effect of galaxy luminosity. 
...
\hline
\hline
NFW w/ Both Constraints		&	7					&	1					&	0				&		2				&		0				&	5					&	1				\\
$[0 \leq L^{\**} \leq 0.6]$		&						&						&					&						&						&						&					\\
\hline
NFW w/ Both Constraints		&	6					&	8					&	2				&		1				&		1				&	5					&	7				\\
$[L^{\**}	> 0.6	]$			&						&						&					&						&						&						&					\\
\enddata
\tablecomments{Comments.}
\end{deluxetable*}
