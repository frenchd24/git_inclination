...
\title{EVIDENCE FOR A ROTATIONAL COMPONENT IN THE CGM OF NEARBY GALAXIES}
...
\begin{figure}
\centering
  \subfigure[]{\includegraphics[width=0.99\linewidth]{SALTmap_velstrict_False_non_True_Lstar_0-100_minsep_False_zoom_1_inclim_0.pdf}}{\label{zoom_map}}
...
\begin{figure}
\centering
  \subfigure[]{\includegraphics[width=0.99\linewidth]{SALTmap_NFW_model_velstrict_True_non_True_Lstar_0-100_minsep_False_inclim_0.pdf}\label{nfw_map}}
...
5. Co-rotating absorbers (when chosen from the sample restricted to $\Delta v \leq \lvert v_{\rm rot} \rvert \pm 10$ \kms) occupy a wide range in Doppler b-parameter, while anti-rotators have mostly $b \leq 50$ \kms. A remarkably similar split is found for absorbers near $L \lesssim 0.6 L^{\**}$ vs $L \gtrsim 0.6 L^{\**}$ galaxies.
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{CGCG039-137_Finding_chart.png}\label{finderchart_CGCG039-137}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{RFGC3781_FindingChart.png}\label{finderchart_ESO343-G014}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{IC5325_FindingChart.png}\label{finderchart_IC5325}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{MCG-03-58-009_FindingChart.png}\label{finderchart_MCG-03-58-009}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{NGC1566_FindingChart.png}\label{finderchart_NGC1566}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{NGC3513_Finding_chart.png}\label{finderchart_NGC3513}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{NGC3633_FindingChart.png}\label{finderchart_NGC3633}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{NGC4536_FindingChart.png}\label{finderchart_NGC4536}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{NGC4939_FindingChart.png}\label{finderchart_NGC4939}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{NGC5364_FindingChart.png}\label{finderchart_NGC5364}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{NGC5786_FindingChart.png}\label{finderchart_NGC5786}}
...
\centering
  ...
  \subfigure[]{\includegraphics[width=0.45\linewidth]{UGC09760_FindingChart.png}\label{finderchart_UGC09760}}
