...
\subsection{NGC3631}
NGC3631 is a mostly face-on ($i = 17^{\circ}$) SA(s)c galaxy located at $V_{sys} = 1156 \pm 1$ \kms~. We take the rotation curve and orientation information from \cite{knapen1997}. The background QSO SDSSJ111443.70+525834.0 is located Southwest at $\rho = 145$ kpc and $72^{\circ}$ azimuth angle on the receding side of NGC3631. We detect $Ly\alpha$ at $V_{Ly\alpha} = 1163$ \kms~($\Delta v = 7$ \kms).


The background QSO SDSSJ111443.70+525834.0 is located Southwest at $\rho = 145$ kpc and $72^{\circ}$ azimuth angle on the receding side of NGC3631. We detect $Ly\alpha$ at $V_{Ly\alpha} = 1163$ \kms~($\Delta v = 7$ \kms).
