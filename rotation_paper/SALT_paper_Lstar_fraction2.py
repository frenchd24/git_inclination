...
#         bins = arange(0, 100, 100)
        ...
        for m, e_L, ra, dec, L in zip(markerColorList_NFWmodel, e_LstarList, RA_targetList, Dec_targetList, LstarList):
            ...
            if withinRange(L, [0.2501, 0.5], 0.0):
                if m == color_yes:
                    corotate_04 +=1.
                    e_Lstar_04 += e_L**2
            ...
            if withinRange(L, [0.5001, 0.75], 0.0):
                if m == color_yes:
                    corotate_06 +=1.
                    e_Lstar_06 += e_L**2
            ...
            if withinRange(L, [0.7501, 1.0], 0.0):
                if m == color_yes:
                    corotate_08 +=1.
                    e_Lstar_08 += e_L**2
            ...
            if withinRange(L, [1.001, 1.25], 0.0):
                if m == color_yes:
                    corotate_1 +=1.
                    e_Lstar_1 += e_L**2
            ...
            if withinRange(L, [1.2501, 1.5], 0.0):
                if m == color_yes:
                    corotate_12 +=1.
                    e_Lstar_12 += e_L**2
                    print 'Lstar: ',L
            ...
            if withinRange(L, [1.5001, 1.75], 0.0):
                if m == color_yes:
                    corotate_14 +=1.
                    e_Lstar_14 += e_L**2
                    print 'Lstar: ',L
            ...
            if withinRange(L, [1.7501, 100.0], 0.0):
                if m == color_yes:
                    corotate_16 +=1.
                    e_Lstar_16 += e_L**2
                    print 'Lstar: ',L
        ...
        print 'corotate_02 = ',corotate_02
        print 'total_04 = ',total_04
        print 'corotate_04 = ',corotate_04
        print 'total_06 = ',total_06
        print 'corotate_06 = ',corotate_06
        print 'total_08 = ',total_08
        print 'corotate_08 = ',corotate_08
        print 'total_1 = ',total_1
        print 'corotate_1 = ',corotate_1
        print 'total_12 = ',total_12
        print 'corotate_12 = ',corotate_12
        print 'total_14 = ',total_14
        print 'corotate_14 = ', corotate_14
        print 'total_16 = ',total_16
        print 'corotate_16 = ',corotate_16
        print
        print
        ...
        lstars = np.arange(0.25, 2.0, 0.25)
        try:
...
#         bins = arange(0, 100, 100)
        ...
        plot(lstars, fraction, lw=2, marker = 'D', color=color_yes, ms=15, markeredgecolor='black')
        
        xTagOffset = -12
        yTagOffset = -25
        for l, f, f_str in zip(lstars,fraction, fraction_str):
            annotate(f_str,xy=(l, f),\
            xytext=(xTagOffset,yTagOffset),textcoords='offset points',size=10)        
