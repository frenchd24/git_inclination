...
\begin{deluxetable*}{l l l l l l l l l l}[bt]
%\rotate
\tablewidth{0pt}
...
For each 1-D spectrum, we identify the H$\alpha$ emission lines and perform a non-linear least-squares Voigt profile fit using the Python package LMFIT\footnote{\url{http://cars9.uchicago.edu/software/python/lmfit/contents.html}}. While normally Gaussian profiles are used for fitting emission lines, we found a Voigt profile resulting in a better fit of the peak velocity. The line centroid and 1$\sigma$ standard errors are returned, and these fits are then shifted to rest-velocity based on the galaxy systemic redshift and heliocentric velocity corrections are calculated with the IRAF rvcorrect procedure. The final rotation velocity is calculated by then applying the inclination correction, $v_{rot} = v / \sin(i)$. Final errors are calculated as a quadrature sum of $1\sigma$ fit errors, systemic redshift error, and inclination uncertainty as follows:
...
%        \includegraphics[width=0.36\textwidth]{NGC3633_splineFit_linear.jpg}
        \includegraphics[width=0.335\linewidth]{NGC3633_2_rotation_curve_xphys_helio_vobs_vrotObs_new5.pdf}
        \includegraphics[width=0.33\linewidth]{NGC3633_NFW_138.jpg}
        \includegraphics[width=0.31\linewidth]{NGC3633-RX_J1121_2+0326_model_plot3.pdf}
...
\begin{figure*}[ht!]
        \centering
        \vspace{0pt}
        \includegraphics[width=0.9\linewidth]{SALTmap_velstrict_False_non_True_Lstar_0-100_minsep_False_inclim_0.pdf}
...
\begin{figure}[ht!]
\centering
  \includegraphics[width=1.\linewidth]{SALTmap_velstrict_False_non_True_Lstar_0-100_minsep_False_zoom_1_inclim_0.pdf}
...
\begin{figure}[ht!]
\centering
  \subfigure[]{\includegraphics[width=0.98\linewidth]{SALT_bhist_NFW_velstrict_True_non_True_Lstar_06_minsep_False_fits_True.pdf}\label{b_hist}}
  \subfigure[]{\includegraphics[width=0.98\linewidth]{SALT_b_vs_dv_NFW_velstrict_True_non_True_Lstar_False_minsep_False_fits_True.pdf}}\label{b_vs_dv2}
