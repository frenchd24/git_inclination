...
#     outfile = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC4565/NGC4565_rotation_curve2.csv'
    ...
    filename = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC4565/NGC4565_rotation_curve_redo.csv'
    outfile = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC4565/NGC4565_rotation_curve_redo2.csv'

    inFile = open(filename,'rU')
    reader = csv.DictReader(inFile)

    fieldnames = ('R','vel','err')
    ...
    ratios = [0.120, 0.120, 0.140, 0.320, 0.320]
    incs = []
    for r in ratios:
        q0 = 0.2
