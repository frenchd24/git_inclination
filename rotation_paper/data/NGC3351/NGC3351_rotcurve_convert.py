...
#     outfile = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC3351/NGC3351_dicaire_rotation_curve2.csv'
    ...
    filename = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC3351/NGC3351_dicaire_rotation_curve_redo.csv'
    outfile = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC3351/NGC3351_dicaire_rotation_curve_redo2.csv'
    ...
    ratios = [0.920, 0.880, 0.880, 0.890]
    incs = []
    for r in ratios:
        q0 = 0.2
