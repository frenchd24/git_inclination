...
#     outfile = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC3631/NGC3631_rotation_curve2.csv'
    ...
    filename = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC3631/NGC3631_rotation_curve_redo.csv'
    outfile = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC3631/NGC3631_rotation_curve_redo2.csv'
...
#     vsys_err +=2
    ...
    ratios = [0.830, 1.0, 0.950, 0.960, 0.960, 0.650, 0.850, 0.880]
    incs = []
    for r in ratios:
        q0 = 0.2
