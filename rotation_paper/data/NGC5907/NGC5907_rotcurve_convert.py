...
def main():
#     filename = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC5907/NGC5907_rotation_curve.csv'
#     outfile = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC5907/NGC5907_rotation_curve2.csv'

    filename = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC5907/NGC5907_rotation_curve_redo.csv'
    outfile = '/Users/frenchd/Research/inclination/git_inclination/rotation_paper/data/NGC5907/NGC5907_rotation_curve_redo2.csv'
    ...
    ratios = [0.140, 0.090, 0.110, 0.160, 0.160]
    incs = []
    for r in ratios:
        q0 = 0.2
