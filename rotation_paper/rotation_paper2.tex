...
RX\_J1017.5+4702			&      NGC3198			&     10 17 31.0			&	+47 02 25.0  	&   0.33544  	& 13314		&   G130M	&   Obs ID  & Obs Date  & 8655  &       12           \\
...
\subsection{UGC09760}
UGC09760 is an edge-on, slow-rotating Sd galaxy with a single sightline toward SDSSJ151237.15+012846.0 located 123 kpc away along the minor axis. Our measured systemic velocity,  $V_{sys} = 2094 \pm 16$, deviates slightly from other published redshifts, such as the The Updated Zwicky Catalog value of $V_{sys} = 2023 \pm 2$ \citep{falco1999}. We detect Ly$\alpha$ absorption at 2051 \kms ($\Delta v = -43$ \kms). This velocity matches well with the rotation velocity of UGC09760 ($V_{rot} = 46 \pm 16$ \kms), but unfortunately this sightlines lies almost exactly at an azimuth of $90^{\circ}$. Hence, the motion of this gas gas could easily be either co-rotating or counter-rotating depending on a minute change in the position angle assigned to UGC09760. This is especially true if we assume our measured $V_{sys}$ is erroneously high, and indeed closer to the values obtained by other observations.
...
\subsection{UGC06446}
$V_{sys} = 645$ \kms (\cite{swaters2009}, \cite{verheijen2001}) \\
...
\subsection{UGC06399}
 $V_{sys} = 791$ \kms \cite{swaters2009} \\
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{CGCG039-137_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_CGCG039-137}}
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{IC5325_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_IC5325}}
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{MCG-03-58-009_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_MCG-03-58-009}}
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{NGC1566_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC1566}}
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{NGC3513_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC3513}}
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{NGC3633_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC3633}}
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{NGC4536_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC4536}}
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{NGC4939_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC4939}}
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{NGC5364_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC5364}}
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{NGC5786_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC5786}}
...
\begin{figure}[t!]
\centering
  \subfigure[]{\includegraphics[width=.5\linewidth]{RFGC3781_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_RFGC3781}}
