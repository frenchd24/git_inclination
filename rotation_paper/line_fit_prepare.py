...
def main():
    ...
    outDirectory = '/Users/frenchd/Research/inclination/line_fits_prepared/'
...
#         new_f5 = directory+f+'_5.txt'
        ...
        np.savetxt(directory+new_f1, np.transpose([content[0],content[1],content[2]]))
...
#         np.savetxt(new_f5, np.transpose([content[0],content[6],content[10]]))
        ...
        pars_file = open(directory + f_name + '.pars', 'wt')
        ...
        pars_file.write('lines HI_1  velspan=600 \n')
        pars_file.write('\n')
        pars_file.write('component  HI  0.     20.  13.3   velocity var_z=False \n')
        pars_file.write('\n')
