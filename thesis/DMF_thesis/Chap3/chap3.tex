\chapter[Probing Large Galaxy Halos]{Probing Large Galaxy Halos at $z\sim0$ with Automated $\rm L \MakeLowercase{y} \alpha$-Absorption Matching} 
\label{chap:chap3}
...
\begin{figure}
\centering
  \subfigure[]{\includegraphics[width=0.55\linewidth]{Chap3/figures/fig2.pdf}\label{line}}
...
\begin{figure}[ht]
\centering
\subfigure[]{\label{w_vir}\includegraphics[width=0.49\textwidth]{Chap3/figures/fig6.pdf}}
