\chapter[THE ENVIRONMENTAL DEPENDENCE OF LOW-$z$ LY$\alpha$ ABSORPTION]{THE ENVIRONMENTAL DEPENDENCE OF LOW-$z$ LY$\alpha$ ABSORPTION} 
\label{chap:chap5}
...
\caption[Summary of QSO Sample]{Summary of QSO Sample} \label{QSO:sample} \\
\hline \hline \\[-2ex]
