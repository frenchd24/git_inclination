...
\epigraph{\fixspacing\emph{I'm in my finest hour$-$
Can I be more than just a fool?
It always gets so hard to see$-$
Right before the moon}}{Adam Granduciel}
...
\begin{figure}[ht!]
\centering
  \subfigure[]{\includegraphics[width=0.82\linewidth]{Chap4/figures/SALTmap_velstrict_False_non_True_Lstar_0-100_minsep_False_zoom_1_inclim_0.pdf}}
