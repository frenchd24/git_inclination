...
\caption[Summary of QSO Sample]{Summary of QSO Sample} \label{tab:params} \\
\hline \hline \\[-2ex]
...
\caption[Halo Model Results and Ly$\alpha$ Absorption Properties]{Halo Model Results and Ly$\alpha$ Absorption Properties} \label{models} \\
\hline \hline \\[-2ex]
  \multicolumn{1}{c}{$\#$} & 
  \multicolumn{1}{c}{Galaxy} &
  \multicolumn{1}{c}{Target} &
